...
public interface PrayerInterface {
    ...
    Call<PrayerObject> getCalendarByAddress(@Query("address") String address, @Query("year") String year, @Query("annual") boolean annual, @Query("method") String method, @Query("tune") String tune, @Query("school") String school, @Query("latitudeAdjustmentMethod") String latitudeAdjustmentMethod);
