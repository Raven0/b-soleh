...
public interface PrayerInterface {
    ...
    Call<PrayerObject> getTimingByAddress(@Query("address") String address, @Query("method") String method, @Query("tune") String tune, @Query("school") String school, @Query("latitudeAdjustmentMethod") String latitudeAdjustmentMethod);
}
